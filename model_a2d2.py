...
#         for parma in self.cnn.parameters():
#             parma.requires_grad = False    
...
#     def __init__(self, sequence_len=3):
#         super(CNN3D, self).__init__()
#         self.layer1 = nn.Sequential(
#             nn.Conv3d(sequence_len, 8, kernel_size=3, stride=1, padding=1),
#             nn.BatchNorm3d(8),
#             # nn.ReLU(),
#             # nn.ReLU(),
#             nn.Tanh(),
...
#             # nn.Linear(1024, 1)
#         )
#         self.layer5 = nn.Linear(533, 1)           
    
#     def forward(self, x):
#         out = self.layer1(x[0])
#         out = self.layer2(out)
#         # out = self.skiplayer(out)
#         out = self.layer3(out)
#         out = out.reshape(out.size(0), -1)
#         # out2 = self.speedlayer(x[1])
#         out = self.layer4(out)
