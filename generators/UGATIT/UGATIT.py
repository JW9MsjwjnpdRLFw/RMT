...
class UGATIT(object) :
    ...
    def build_model(self):
        ...
        # self.trainA = ImageFolder(os.path.join('../generators/UGATIT/dataset', self.dataset, 'trainA'), train_transform)
        # self.trainB = ImageFolder(os.path.join('../generators/UGATIT/dataset', self.dataset, 'trainB'), train_transform)
        # self.testA = ImageFolder(os.path.join('../generators/UGATIT/dataset', self.dataset, 'testA'), test_transform)
        # self.testB = ImageFolder(os.path.join('../generators/UGATIT/dataset', self.dataset, 'testB'), test_transform)
