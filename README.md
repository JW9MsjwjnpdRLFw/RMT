...
## How to use RMT
[This video](https://drive.google.com/file/d/1LjEaeKiEA5gVqZa68x-6hstnkcOoe6s7/view?usp=sharing) shows how to run RMT to implement Rule 6 and [this video](https://drive.google.com/file/d/1fIjeVRVpuhR_YYJEtuFnqBC7H6asI03K/view?usp=sharing) shows how to run RMT to implement Rule 8.
